...
{
    public Texture2D spriteAtlas;       //Атлас спрайтов
    private int currentSpriteID = 0;    //Номер спрайта в списке, который предназначен для отрисовывания в данный момент времени
    public int Rows { get; set; }       //Количество строк
    public int Columns { get; set; }    //Количество столбцов
    private int totalFrames;            //Общее количество кадров (строки*столбцы)
    ...
    public SpriteData(Texture2D initSprite, int _rows, int _columns, int animationSpeed)
    {
